...
export class ReportsService {
  ...
  public postReport(report: Reports): Observable<Reports> {
    return this.http.post<Reports>(GlobalVariables.apiURL+this.reportsURL, report);
  }

  public putReport(report: Reports): Observable<Reports> {
    return this.http.put<Reports>(GlobalVariables.apiURL + this.reportsURL + '/' + report.reportId, report);
  }
}